...
<head>
    <meta charset="utf-8">
    <title>Job Portal - My Job Posts</title>
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-secondary rounded p-4">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        <h6 class="mb-0">My Job Posts</h6>
                    </div>
                     <p>In this section you can view all job posts created by you.</p>
                    <div class="table-responsive">
                        <table class="table text-start align-middle table-bordered table-hover mb-0" id="jobPostsTable">
                             <thead>
                                <tr class="text-white">
                               ...
                               <?php
                                 $sql = "SELECT * FROM job_post WHERE id_company='$_SESSION[id_company]'";
                                  ...
                                  <tr>
                                    ...
                                    <td><a class="btn btn-sm btn-primary" href="view-job-post.php?id=<?php echo $row['id_jobpost']; ?>">View</a></td>
                                  </tr>
                                  <?php
                                   }
                                 }
