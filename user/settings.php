            ...
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="d-flex align-items-center ms-4 mb-4">
                    <div class="position-relative">
                        <!-- You might want to dynamically load user image if available -->
        ...
        <div class="content">
                        ...
                        <div class="dropdown-menu dropdown-menu-end bg-secondary border-0 rounded-0 rounded-bottom m-0">
                            ...
                            <a href="#" class="dropdown-item">
                                <div class="d-flex align-items-center">
                                    <img class="rounded-circle" src="img/user.jpg" alt="" style="width: 40px; height: 40px;">
                                    <div class="ms-2">
                                        <h6 class="fw-normal mb-0">Message example</h6>
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-secondary rounded p-4">
                    <h2 class="mb-4"><i>Settings</i></h2>
                    <div class="row g-4">
                        <!-- Change Password Section -->
                        <div class="col-md-6">
                            <h4 class="mb-3">Change Password</h4>
                            <p>Type in the new password you want to use.</p>
                     ...
                     <?php
                        ...
                        if(isset($_SESSION['accountDeactivated'])) {
                            // Although the user might be logged out, this message could be shown briefly if not redirected immediately
