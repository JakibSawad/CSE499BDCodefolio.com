...
if($filter == "searchBar") {
    ...
    $sql = "SELECT job_post.* FROM job_post INNER JOIN company ON job_post.id_company = company.id_company WHERE company.city = '$search' LIMIT $start_from, $limit";
} else {
...
if($result->num_rows > 0) {
    ...
    echo '<div class="alert alert-info text-center">No job posts matching your search criteria.</div>';
}
