      ...
      <div class="container">
        <div class="row">
          <div class="col-12 text-center">
            <h1 class="display-3 lh-sm mb-5">Sign Up</h1>
          </div>
        </div>
          ...
          <div class="col-md-6 mb-4">
            <div class="card h-100 rounded-3 p-4 bg-primary">
              <div class="card-body text-center">
                <h3 class="text-white mb-4">Candidate Sign Up</h3>
                <p class="text-white-50 mb-4">Create an account to discover and apply for your dream job</p>
                <a href="register-candidates.php" class="btn btn-light btn-lg">
                  Sign Up as Candidate <i class="fas fa-arrow-right ms-2"></i>
                </a>
              </div>
            </div>
          </div>
        ...
        <div class="row justify-content-center">
          <!-- Company Sign Up Card -->
          <div class="col-md-6 mb-4">
            <div class="card h-100 rounded-3 p-4 bg-secondary">
              <div class="card-body text-center">
                <h3 class="text-white mb-4">Company Sign Up</h3>
                <p class="text-white-50 mb-4">Create an account to post jobs and find the perfect candidates</p>
                <a href="register-company.php" class="btn btn-light btn-lg">
                  Sign Up as Company <i class="fas fa-arrow-right ms-2"></i>
                </a>
              </div>
            </div>
          </div>
